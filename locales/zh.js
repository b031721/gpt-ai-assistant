const zh = {
  ...
  __COMMAND_SUM_ORGANIZE_PHONE_LABEL: '整理手機',
  __COMMAND_SUM_ORGANIZE_PHONE_TEXT: '整理我的手機',
  __COMMAND_SUM_ORGANIZE_PHONE_PROMPT: '根據以下內容，提供整理手機的詳細建議，包括整理應用程式、照片、聯絡人和儲存空間的實用步驟。',
  __COMMAND_SUM_ORGANIZE_APPS_LABEL: '分類 App',
  __COMMAND_SUM_ORGANIZE_APPS_TEXT: '幫我把所有 App 分成資料夾',
  __COMMAND_SUM_ORGANIZE_APPS_PROMPT: '根據以下列出的 App 清單，將它們依功能分類並建議適合的資料夾名稱與分組方式，讓手機主畫面更整齊易用。',
