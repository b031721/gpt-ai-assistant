const ja = {
  ...
  __COMMAND_SUM_ORGANIZE_PHONE_LABEL: 'スマホを整理して',
  __COMMAND_SUM_ORGANIZE_PHONE_TEXT: 'スマホを整理して',
  __COMMAND_SUM_ORGANIZE_PHONE_PROMPT: '以下の内容を踏まえ、スマホの整理に関する詳細なアドバイスを提供してください。アプリ、写真、連絡先、ストレージの管理手順を含めてください。',
  __COMMAND_SUM_ORGANIZE_APPS_LABEL: 'アプリをフォルダに分類して',
  __COMMAND_SUM_ORGANIZE_APPS_TEXT: '全てのアプリをフォルダに分類して',
  __COMMAND_SUM_ORGANIZE_APPS_PROMPT: '以下のアプリ一覧を機能別に分類し、適切なフォルダ名とグループ分けを提案してください。ホーム画面をすっきり使いやすくする目的です。',
