const en = {
  ...
  __COMMAND_SUM_ORGANIZE_PHONE_LABEL: 'Organize phone',
  __COMMAND_SUM_ORGANIZE_PHONE_TEXT: 'Organize my phone',
  __COMMAND_SUM_ORGANIZE_PHONE_PROMPT: 'Based on the following content, provide detailed suggestions for organizing a phone, including practical steps for managing apps, photos, contacts, and storage.',
  __COMMAND_SUM_ORGANIZE_APPS_LABEL: 'Sort apps into folders',
  __COMMAND_SUM_ORGANIZE_APPS_TEXT: 'Sort all my apps into folders',
  __COMMAND_SUM_ORGANIZE_APPS_PROMPT: 'Based on the following list of apps, categorize them by function and suggest appropriate folder names and groupings to make the home screen tidier and easier to use.',
